    ...
    <div className="bg-gray-800 rounded-lg p-6">
      ...
      <div className="flex justify-center">
        <svg width="400" height="400" viewBox="0 0 400 400" className="bg-green-600 rounded-full">
          ...
          <text x="100" y="200" textAnchor="middle" fill="#ffffff" fontSize="12" fontWeight="bold">
            Off-side
          </text>
          <text x="300" y="200" textAnchor="middle" fill="#ffffff" fontSize="12" fontWeight="bold">
            On/Leg-side
          </text>
          <text x="200" y="30" textAnchor="middle" fill="#ffffff" fontSize="10" fontWeight="bold">
            Bowler's End
          </text>
          <text x="200" y="385" textAnchor="middle" fill="#ffffff" fontSize="10" fontWeight="bold">
            Striker's End
          </text>
        </svg>
      </div>
